 ...
 *
 */
package org.geobricks.gdal.dem.roughness;
 ...
 *         the elevation. Roughness is the the largest inter-cell difference of
 *         a central pixel and its surrounding cell, as defined in Wilson et al
 *         (2007, Marine Geodesy 30:3-35). The value -9999 is used as the output
 *         nodata value. There are no specific options.
 * 
 */
public class GDALDEMRoughness extends GDALDEM {

	public GDALDEMRoughness(String inputFilepath, String outputFilepath) {
	...
	public String convert() throws Exception {
		...
		this.getSB().append("gdaldem roughness ");
